...
DATABASES = {
    'default': {
        ...
        'NAME': 'DB_TASYPIE',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'p*sw09_a8v^puhsv+49h9y9frlnol!_n286qm^su93w-hsv+%f'
...
INSTALLED_APPS = (
    ...
    'gunicorn',     #Gunicorn #python mange.py run_gunicorn
    'tastypie',
    'TastyApp1',
)
